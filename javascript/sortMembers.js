document.addEventListener('DOMContentLoaded', () => {
  ...
  const statisticsFaculty = [
    ...
    },
    {
      ...
      title: 'Professor',
      degree: 'MS in Statistics <br> University of the Philippines Diliman',
      university: 'Master in Public Health Methodology <br> Free University of Brussels',
      additionalTitle: 'Cluster Coordinator',
    ...
    {
      name: 'Jhoanne Marsh C. Gatpatan, PhD',
