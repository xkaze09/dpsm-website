...
function updateDivisionCarousel() {
  ...
  divisionCarouselTitle.textContent = divisionCarouselData[0].title;
  ...
  divisionCarousel.addEventListener('slid.bs.carousel', function () {
    ...
    divisionCarouselTitle.textContent = divisionCarouselData[activeIndex].title; // Update title dynamically
    divisionCarouselText.textContent = divisionCarouselData[activeIndex].text; // Update text dynamically
  });
}
